...
"border-radius:0px;")
        ...
        self.aviso_ciudadNoSeleccionada.setGeometry(QRect(320, 140, 211, 21))
        ...
        self.recargar.setGeometry(QRect(310, 90, 31, 31))
        self.recargar.setStyleSheet(u"border:none;")
        icon6 = QIcon()
        icon6.addFile(u"../recursos/iconos/refrescar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.recargar.setIcon(icon6)
